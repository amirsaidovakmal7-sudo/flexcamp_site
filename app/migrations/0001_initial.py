# Generated by Django 5.2.15 on 2026-06-18 16:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_description', models.TextField(verbose_name='Описание для домика')),
                ('house_price', models.DecimalField(decimal_places=2, max_digits=25, verbose_name='Стоимость аренды в суммах')),
                ('houser_photo', models.ImageField(upload_to='media', verbose_name='Фотография домика')),
            ],
            options={
                'verbose_name': 'Домик',
